...
<nav>
    ...
    <div class="menu">
      <ul>
        ...
        <li class="active"><a href="user.php"><img src="images/user.png" width="20px" heigh="20px" alt=""> Clients</a></li>
  ...
  <!-- -----------------------------------------content-------------------------------- -->
  <div class="addsuer-btn">
    <a href="adduser.php"><button>Add Users</button></a>
  </div>
  <div class="user-data">
    <table>
      <tr>
       ...
       if($connect){
          ...
          if($rows = mysqli_num_rows($query) > 0){
           while($results = mysqli_fetch_array($query)){
             ...
             $userphoto = "uploaded/".$results['userphoto'];
             $gender = $results['genders'];
             ...
             $organisation = $results['organisation'];
              ...
              echo("<td>".$fullname."</td>");
              echo("<td>");
              echo("<img src='".$userphoto."' width='50px' height='50px'>");
              echo("</td>");
              echo("<td>".$gender."</td>");
         ...
         echo("<script>alert('Un-able to connect to the server')</script>");
       }
    ?>
    </table>
  </div>
